...
def clinic_temp(c):
    ...
    c.drawImage('clinic/static/images/knee.png',0.5*inch,7*inch)
    c.drawImage("clinic/static/images/aa.png",4.5*inch,7*inch)
    c.drawImage('clinic/static/images/b.png',4.4*inch,5.4*inch)
